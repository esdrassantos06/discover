...
const DarkModeSwitch = () => {
    ...
    return (
        ...
        <button id="switch"
            ...
            className="w-12 z-10 h-5 rounded-2xl bg-lightModeBackground border-surfaceLightMode dark:border-surfaceDarkMode border border-opacity-10 border-solid bg-opacity-10 hover:bg-opacity-5 flex items-center transition duration-300 focus:outline-none">
